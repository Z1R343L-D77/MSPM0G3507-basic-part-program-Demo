...
void set_PWM0_duty(float duty,u8 channel) 
{
    ...
    {
        case 0:
            DL_TimerA_setCaptureCompareValue(CAR_PWM0_INST, CompareValue, DL_TIMER_CC_0_INDEX);
        break;
        
        case 1:
            DL_TimerA_setCaptureCompareValue(CAR_PWM0_INST, CompareValue, DL_TIMER_CC_1_INDEX);
        break;
				
        case 2:
            DL_TimerA_setCaptureCompareValue(CAR_PWM0_INST, CompareValue, DL_TIMER_CC_2_INDEX);
        break;
        
        case 3:
            DL_TimerA_setCaptureCompareValue(CAR_PWM0_INST, CompareValue, DL_TIMER_CC_3_INDEX);
        break;
